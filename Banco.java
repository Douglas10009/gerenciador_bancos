        ...
        switch (menu) {
          case 1: // Sacar
            ...
            if (saque > esseSaldo) {
              ...
              System.out.println("Saque realizado com sucesso! Seu saldo atual é de R$" + esseSaldo);
            }

            break;

          case 2: // Mostra o saldo
            System.out.println("Seu saldo é de: R$" + esseSaldo);
            break;
          ...
          case 3:// Depositar
            ...
            System.out.println("Depósito realizado com sucesso! Seu saldo atual é de R$" + esseSaldo);
            break;
          ...
          case 4:// Transferência
            ...
            if (transferencia > esseSaldo) {
              ...
              if (contains(conta, contaTransferida)) {
                ...
                System.out.println("Transferência realizada com sucesso! Seu saldo atual é de R$" + esseSaldo);
            ...
            // }else {
            // saldo[i] =- transferencia; // Retira o valor do saldo
            // saldo[j] =+ transferencia; // Adiciona o valor ao saldo
            // System.out.println("Transferência realizada com sucesso! Seu saldo atual é de
            // R$" + saldo);
          ...
          case 5: // Cadastra um novo usuário
            ...
            // Preciso de uma variável que defina
            i++;
            j++;
